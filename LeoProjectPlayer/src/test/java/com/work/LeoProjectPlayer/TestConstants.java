...
public class TestConstants {
    ...
    public static final List<Player> LIST_OF_PLAYERS = List.of(
            new Player(1,"Robin", "Rytkonen", "Bobzoor@gmail.com", 988765, "Vetlanda", "Sweden", 0.0),
            new Player(2,"Robin1", "Rytkonen1", "Bobzoor@gmail.com1", 988765, "Vetlanda", "Sweden", 0.0),
            new Player(3,"Robin2", "Rytkonen2", "Bobzoor@gmail.com2", 988765, "Vetlanda", "Sweden", 0.0)
    );

    public static final Player PLAYER = new Player(1,"Robin", "Rytkonen", "Bobzoor@gmail.com", 988765, "Vetlanda", "Sweden", 0.0);
